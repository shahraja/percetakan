        ...
        <div class="row">
            ...
            <div class="col border rounded shadow p-4 mx-2">
                ...
                @if ($product->judul == 'Buku' || $product->judul == 'Majalah')
                    ...
                    {{-- <div class="form-group row pe-2">
                        <label class="form-label col-md-3" for="laminasi_cover">Laminasi Cover</label>
                        <select name="laminasi_cover" id="laminasi_cover" class="form-select col-md-9">
                            <option value=""></option>
                            <option value="glossy">Glossy</option>
                            <option value="doff">Doff</option>
                        </select>
                    </div> --}}
                    <!-- Select untuk jenis finishing -->
                    <div class="form-group row pe-2">
